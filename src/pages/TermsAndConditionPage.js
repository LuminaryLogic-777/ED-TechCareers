  ...
  return (
    <Layout>
      <div className="lg:mx-28 px-5 lg:px-10 py-10 font-base bg-white">
        ...
        <p className="font-semibold text-sm mb-5">Updated at 2022-08-27</p>

        <h1 className="text-xl font-bold text-gray-700 my-5">General Terms</h1>
        <p className="mb-3">
          By accessing and placing an order with MAANG Careers, you confirm that
          ...
          you and MAANG Careers.
        </p>
        <p className="mb-3">
          Under no circumstances shall MAANG Careers team be liable for any
          ...
          MAANG Careers team or an authorized representative has been advised of
        ...
        <p>
          MAANG Careers will not be responsible for any outcome that may occur
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">License</h1>
        <p className="mb-3">
          MAANG Careers grants you a revocable, non-exclusive, non-transferable,
          limited license to download, install and use the website strictly in
          accordance with the terms of this Agreement.
        </p>
        <p className="mb-3">
          These Terms & Conditions are a contract between you and MAANG Careers
          (referred to in these Terms & Conditions as "MAANG Careers", "us",
          "we" or "our"), the provider of the MAANG Careers website and the
          services accessible from the MAANG Careers website (which are
          collectively referred to in these Terms & Conditions as the "MAANG
          Careers Service").
        </p>
        <p>
          You are agreeing to be bound by these Terms & Conditions. If you do
          not agree to these Terms & Conditions, please do not use the MAANG
          Careers Service. In these Terms & Conditions, "you" refers both to you
        ...
        <ul className="list-disc mx-5 my-5 space-y-4">
          <li>
          ...
          <li>
            ...
            it refers to MAANG Carees (OPC) PRIVATE LIMITED, D.NO: 2-98/2,
            Lingamguntla, Kavuru, Guntur, Andhra Pradesh, India, 522611 that is
            responsible for your information under this Terms & Conditions.
          </li>
          <li>
            Country: where MAANG Careers or the owners/founders of MAANG Careers
          ...
          <li>
            Service: refers to the service provided by MAANG Careers as
          ...
          <li>
            Website: MAANG Careers's site, which can be accessed via this URL:
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Restrictions</h1>
        ...
        <ul className="list-disc m-5 space-y-4">
          ...
          <li>
            ...
            notice of copyright or trademark) of MAANG Careers or its
        ...
        <p className="mb-3">
          We'll be as brief as our
          attorneys will allow. The main thing to remember is that by placing an
          order or making a purchase at MAANG Careers, you agree to the terms
          along with MAANG Careers's Privacy Policy.
        </p>
        <p className="mb-3">
        ...
        <p className="mb-3">
          ...
          (collectively, "Suggestions") provided by you to MAANG Careers with
          respect to the website shall remain the sole and exclusive property of
          MAANG Careers.
        </p>
        <p className="mb-3">
          MAANG Careers shall be free to use, copy, modify, publish, or
        ...
        <p>
          ...
          contain links to other websites not operated or controlled by MAANG
          Careers. We are not responsible for the content, accuracy or opinions
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Cookies</h1>
        <p>
          MAANG Careers uses "Cookies" to identify the areas of our website that
        ...
        <p className="mb-3">
          You acknowledge and agree that MAANG Careers may stop permanently or
          temporarily providing the Service (or any features within the Service)
          to you or to users generally at MAANG Careers's sole discretion,
          without prior notice to you. You may stop using the Service at any
          time. You do not need to specifically inform MAANG Careers when you
          stop using the Service. You acknowledge and agree that if MAANG
          Careers disables access to your account, you may be prevented from
        ...
        <p>
          MAANG Careers reserves the right to modify, suspend or discontinue,
        ...
        <p className="mb-3">
          MAANG Careers may from time to time provide enhancements or
        ...
        <p className="mb-3">
          ...
          of the website. You agree that MAANG Careers has no obligation to (i)
        ...
        <p className="mb-3">
          You acknowledge and agree that MAANG Careers shall not be responsible
          ...
          or any other aspect thereof. MAANG Careers does not assume and shall
        ...
        <p className="mb-3">
          This Agreement shall remain in effect until terminated by you or MAANG
          Careers.
        </p>
        <p className="mb-3">
          MAANG Careers may, in its sole discretion, at any time and for any or
        ...
        <p className="mb-3">
          ...
          MAANG Careers, in the event that you fail to comply with any provision
        ...
        <p className="mb-3">
          Termination of this Agreement will not limit any of MAANG Careers's
        ...
        <p>
          You agree to indemnify and hold MAANG Careers and its parents,
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">No Warranties</h1>
        <p className="mb-3">
          The website is provided to you "AS IS" and "AS AVAILABLE" and with all
          faults and defects without warranty of any kind. To the maximum extent
          permitted under applicable law, MAANG Careers, on its own behalf and
          ...
          trade practice. Without limitation to the foregoing, MAANG Careers
        ...
        <p className="mb-3">
          Without limiting the foregoing, neither MAANG Careers nor any MAANG
          Careers's provider makes any representation or warranty of any kind,
          ...
          of MAANG Careers are free of viruses, scripts, trojan horses, worms,
        ...
        <p className="mb-3">
          ...
          of MAANG Careers and any of its suppliers under any provision of this
        ...
        <p className="mb-3">
          ...
          MAANG Careers or its suppliers be liable for any special, incidental,
          ...
          provision of this Agreement), even if MAANG Careers or any supplier
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Severability</h1>
        <p className="mb-3">
        ...
        <p className="mb-3">
          ...
          notices published by MAANG Careers on the Services, shall constitute
          the entire agreement between you and MAANG Careers concerning the
          ...
          waiver of such term or any other term, and MAANG Careers's failure to
          assert any right or provision under this Agreement shall not
          constitute a waiver of such right or provision. YOU AND MAANG Careers
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Waiver</h1>
        <p className="mb-3">
        ...
        <p className="mb-3">
          MAANG Careers reserves the right, at its sole discretion, to modify or
        ...
        <p>
          ...
          agree to the new terms, you are no longer authorized to use MAANG
          Careers.
        </p>
        ...
        <p className="mb-3">
          The Agreement constitutes the entire agreement between you and MAANG
          Careers regarding your use of the website and supersedes all prior and
          contemporaneous written or oral agreements between you and MAANG
          Careers.
        </p>
        <p>
          You may be subject to additional terms and conditions that apply when
          you use or purchase other MAANG Careers's services, which MAANG
          Careers will provide to you at the time of such use or purchase.
        </p>
        ...
        <p>
          ...
          arrangement thereof), are owned by MAANG Careers, its licensors or
          other providers of such material and are protected by IN and
          ...
          MAANG Careers, unless and except as is expressly provided in these
        ...
        <p>
          ...
          REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR MAANG Careers's
          INTELLECTUAL PROPERTY RIGHTS. The term “dispute” means any dispute,
          action, or other controversy between you and MAANG Careers concerning
        ...
        <p>
          In the event of a dispute, you or MAANG Careers must give the other a
          ...
          <a
            ...
            class="__cf_email__"
            data-cfemail="11626461617e6365517c70707f76727063747463623f727e7c3f"
          >
            [email&#160;protected]
          </a>{" "}
          MAANG Careers will send any Notice of Dispute to you by mail to your
          address if we have it, or otherwise to your email address. You and
          MAANG Careers will attempt to resolve any dispute through informal
          negotiation within sixty (60) days from the date the Notice of Dispute
          is sent. After sixty (60) days, you or MAANG Careers may commence
          arbitration.
        </p>
        ...
        <p>
          If you and MAANG Careers don't resolve any dispute by informal
        ...
        <p>
          ...
          and will become the sole property of MAANG Careers without any
          compensation or credit to you whatsoever. MAANG Careers and its
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Promotions</h1>
        <p className="mb-3">
          MAANG Careers may, from time to time, include contests, promotions,
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Miscellaneous</h1>
        <p>
          ...
          representative of MAANG Careers. MAANG Careers will be entitled to
          ...
          breach by you. MAANG Careers operates and controls the MAANG Careers
          Service from its offices in IN. The Service is not intended for
          distribution to or use by any person or entity in any jurisdiction or
          country where such distribution or use would be contrary to law or
          regulation. Accordingly, those persons who choose to access the MAANG
          Careers Service from other locations do so on their own initiative and
          ...
          include and incorporate the MAANG Careers Privacy Policy) contains the
          entire understanding, and supersedes all prior understandings, between
          you and MAANG Careers concerning its subject matter, and cannot be
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Disclaimer</h1>
        <p className="mb-3">
          MAANG Careers is not responsible for any content, code or any other
          imprecision.
        </p>
        <p className="mb-3">
          MAANG Careers does not provide warranties or guarantees.
        </p>
        <p>
          In no event shall MAANG Careers be liable for any special, direct,
        ...
        <p className="mb-3">
          The MAANG Careers Service and its contents are provided "as is" and
          "as available" without any warranty or representations of any kind,
          whether express or implied. MAANG Careers is a distributor and not a
          publisher of the content supplied by third parties; as such, MAANG
          Careers exercises no editorial control over such content and makes no
          ...
          or accessible via the MAANG Careers Service. Without limiting the
          foregoing, MAANG Careers specifically disclaims all warranties and
          representations in any content transmitted on or in connection with
          the MAANG Careers Service or on sites that may appear as links on the
          MAANG Careers Service, or in the products provided as a part of, or
          otherwise in connection with, the MAANG Careers Service, including
          without limitation any warranties of merchantability, fitness for a
          particular purpose or non-infringement of third party rights. No oral
          advice or written information given by MAANG Careers or any of its
          ...
          change without notice. Without limiting the foregoing, MAANG Careers
          does not warrant that the MAANG Careers Service will be uninterrupted,
