  ...
  return (
    <Layout>
      <div className="lg:mx-28 px-5 lg:px-10 py-10 font-base bg-white">
        ...
        <p className="mb-5">
          {" "}
          MAANG Careers (“we,” “our,” or “us”) is committed to protecting your
          privacy. This Privacy Policy explains how your personal information is
          collected, used, and disclosed by MAANG Careers.
        </p>
        <p>
          ...
          MAANG Careers. By accessing or using our Service, you signify that you
        ...
        <p>
          ...
          <ul className="mt-5 space-y-2">
            <li>
              <span className="font-semibold">Cookie:</span> small amount of
              data generated by a website and saved by your web browser. It is
              used to identify your browser, provide analytics, remember
            ...
            <li>
              ...
              mentions “Company,” “we,” “us,” or “our,” it refers to MAANG
              Careers (OPC ) PRIVATE LIMITED, D.NO: 2-98/2, Lingamguntla,
              Kavuru, Guntur, Andhra Pardesh, India,522611 that is responsible
              for your information under this Privacy Policy.
            </li>
            <li>
              <span className="font-semibold">Country:</span> where MAANG
              Careers or the owners/founders of MAANG Careers are based, in this
              case is India
            </li>
            <li>
              <span className="font-semibold">Customer:</span> refers to the
              company, organization or person that signs up to use the MAANG
              Careers Service to manage the relationships with your consumers or
              service users.
            </li>
            <li>
              <span className="font-semibold">Device:</span> any internet
              connected device such as a phone, tablet, computer or any other
              device that can be used to visit MAANG Careers and use the
              services.
            </li>
            <li>
            ...
            <li>
              ...
              individuals who are employed by MAANG Careers or are under
            ...
            <li>
              ...
              that is registered with MAANG Careers to use the Services.
            </li>
          </ul>
        </p>
        <h1 className="text-xl font-bold text-gray-700 my-5">
        ...
        <ul className="list-disc font-medium space-y-5 my-5 mx-5">
          <li>Name / Username</li>
          <li>Phone Numbers</li>
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">
          When does MAANG Careers use end user information from third parties?
        </h1>
        <p className="mb-3">
          MAANG Careers will collect End User Data necessary to provide the
          MAANG Careers services to our customers.
        </p>
        <p className="mb-3">
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">
          When does MAANG Careers use customer information from third parties?
        </h1>
        <p className="mb-3">
          ...
          interest in becoming a MAANG Careers customer, we receive information
          from a third party that provides automated fraud detection services to
          MAANG Careers. We also occasionally collect information that is made
        ...
        <p>
          MAANG Careers will collect personal information that you submit to us.
        ...
        <p>
          We keep your information only so long as we need it to provide MAANG
          Careers to you and fulfill the purposes described in this policy. This
        ...
        <p>
          ...
          absolute security of any information you transmit to MAANG Careers or
        ...
        <p>
          MAANG Careers is incorporated in India. Information collected via our
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">
          Is the information collected through the MAANG Careers Service secure?
        </h1>
        <p>
        ...
        <p className="mb-3">
          ...
          information MAANG Careers collects depend on your relationship with
          MAANG Careers. Personnel may update or correct their information as
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Personnel</h1>
        <p className="mb-3">
          If you are a MAANG Careers worker or applicant, we collect information
        ...
        <p>
          ...
          of the assets of MAANG Careers or any of its Corporate Affiliates (as
          defined herein), or that portion of MAANG Careers or any of its
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Affiliates</h1>
        <p>
          ...
          MAANG Careers, whether by ownership or otherwise. Any information
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Governing Law</h1>
        <p className="mb-3">
        ...
        <p>
          By using MAANG Careers or contacting us directly, you signify your
        ...
        <h1 className="text-xl font-bold text-gray-700 my-5">Kids' Privacy</h1>
        <p>
