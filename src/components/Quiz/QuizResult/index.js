      ...
      <div className="xl:w-3/12 lg:w-4/12 w-full px-4 lg:text-start text-center">
        ...
        <div className="xl:w-9/12 lg:w-8/12 w-full px-4">
          <div className="quiz-result-header-content-top lg:!justify-start !justify-center">
            ...
            <span className="percentage" style={{ color: !isPass ?  "red" : "" }}>{percentage}%</span>
          </div>
          <div className="quiz-result-header-content-bottom xl:!p-5 sm:!p-4 bg-till-100 bg-opacity-50">
            ...
            <div className="flex flex-wrap justify-center -mx-4 gap-y-4">
              <div className="xl:w-[20%] lg:w-[33.333333%] md:w-[20%] sm:w-[33.333333%] w-[50%] px-2 text-center">
                <div className="value text-gray-700 text-[25px] font-bold">{attempt+1}</div>
                <div className="lable text-gray-600 text-base font-normal">Attempt</div>
              </div>
              <div className="xl:w-[20%] lg:w-[33.333333%] md:w-[20%] sm:w-[33.333333%] w-[50%] px-2 text-center">
                <div className="value text-gray-700 text-[25px] font-bold">{list.length}</div>
                <div className="lable text-gray-600 text-base font-normal">Total Questions</div>
              </div>
              <div className="xl:w-[20%] lg:w-[33.333333%] md:w-[20%] sm:w-[33.333333%] w-[50%] px-2 text-center">
                <div className="value text-gray-700 text-[25px] font-bold">{correctAnswers}</div>
                <div className="lable text-gray-600 text-base font-normal">Correct Answers</div>
              </div>
              <div className="xl:w-[20%] lg:w-[33.333333%] md:w-[20%] sm:w-[33.333333%] w-[50%] px-2 text-center">
                <div className="value text-gray-700 text-[25px] font-bold">{wrongAnswer}</div>
                <div className="lable text-gray-600 text-base font-normal">Wrong Answers</div>
              </div>
              <div className="xl:w-[20%] lg:w-[33.333333%] md:w-[20%] sm:w-[33.333333%] w-[50%] px-2 text-center">
                <div className="value text-gray-700 text-[25px] font-bold">{percentage}%</div>
                <div className="lable text-gray-600 text-base font-normal">Score</div>
              </div>
            </div>
          </div>
        </div>
              ...
              {list.map((quizItem) => {
                ...
                return (
                  <div className="answer-body">
                    <div className="">
                      <span className="text-gray-700 text-base font-medium font-['Outfit'] pr-1">{id}.</span>
                      <span className="text-gray-700 text-base font-medium font-['Outfit']">{question}</span>
                    </div>
