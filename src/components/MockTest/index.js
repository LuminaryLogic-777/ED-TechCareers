...
const MockTest = () => {
  ...
  const { screen, setScreen, setIsShowMiniSidebar, isShowMiniSidebar,  selectedCourseIdForMock,setSelectedCourseIdForMock} =
                ...
                <div className="course-tags">
                  {tags.map(
                    (
                      ...
                      <div
                        key={id}
                        className={id === (selectedCourseIdForMock || tag) ? "active-tag" : ""}
