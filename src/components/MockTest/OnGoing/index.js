...
const OnGoing = ({ courseId, week }) => {
      ...
      <div className="stepper-box">
        <div className="step-item">
          ...
          <div className="content">
            <a
              className={selectedQs === steps.q_id ? activeClass : steps.que_status ? "submitAns":""}
              onClick={() => {
  ...
  const submitAll = async () => {
    ...
    fetch(
      `${ApiBaseURL}test-management/std-mock-question-submission-all/`,
      {
        method: "POST",
        headers: {
  ...
  return (
    <div class="p-5">
      <div className="practice-ongoing">
        <div className="left">
          {list.map((item) => {
