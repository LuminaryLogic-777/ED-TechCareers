...
const OnGoing = ({ courseId, week, selectedQsId }) => {
  ...
  const {selectedWeekIdForNavTeaching,setSelectedWeekIdForNavTeaching,selectedQsIdForTeaching,setSelectedQsIdForTeaching} =
                ...
                <a
                  ...
                  onClick={() => {
                    window.location.href =
                      "/mentor/teaching/" + step?.q_id + "/problem";
                    setTagDisable(true);
                  }}
  ...
  useEffect(() => {
    ...
    fetchFakeData();
  }, [loggedIn,selectedWeekIdForNavTeaching,selectedQsIdForTeaching,selectedQs, week]);
