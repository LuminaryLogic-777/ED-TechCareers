...
const CodeEditor = ({
  ...
  // useEffect(() => {
  //   setLoading(true);
  //   console.log("problemData", problemData.pre_code);
  //   if (selectedQs) {
  //     fetch(
  //       `https://devdjango.maangcareers.com/test-management/std-practice-question-temp/?question_id=${selectedQs}`,
  //       {
  //         method: "GET",
  //         headers: {
  ...
  //         if (problemData.pre_code === null) {
  //           setCodeValue(compilersData[0].load_template);
  //           console.log("-------------------------------------->",codeValue);
  //           setReset(false);
  //         } else {
  //           setCodeValue(problemData.pre_code);
  //         }
  //       })
  //       .catch((error) => {
  //         setLoading(false);
  ...
  const handleSubmitCode = (buttonClicked) => {
    ...
    fetch(
      `${ApiBaseURL}test-management/std-practice-question-submission/`,
      {
        method: "POST",
        headers: {
          Authorization: `Token ${JSON.parse(loggedIn).token}`,
  ...
  const autoSave = async () => {
    ...
    fetch(
      `${ApiBaseURL}test-management/std-practice-save-code/`,
      {
        method: "POST",
        headers: {
          Authorization: `Token ${JSON.parse(loggedIn).token}`,
  ...
  useEffect(() => {
    // console.log("testCase Imran", testCase);
    // console.log("clickedItems Imran", clickedItems);
    // console.log("isClicked Imran", isClicked);
