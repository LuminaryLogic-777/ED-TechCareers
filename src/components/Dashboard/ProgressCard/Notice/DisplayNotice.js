...
const DisplayNotice = ({ notices }) => {
  ...
  return (
    <div className="notice-content bg-white mt-6 rounded-2xl shadow-[0px_5px_25px_0px_rgba(62,144,156,0.10)] max-h-[304px] overflow-y-auto">
      <span className="block Outfit text-xl font-semibold text-slate-600 px-5 pt-4">
        Notice Board
      </span>
      <div className="flex flex-col">
        {notices.map((notice, idx) => (
            ...
            <div className="notice-img w-0/6 mr-3">
              <div
                className={`notice-img w-16 h-16 rounded flex justify-center items-center border border-solid ${
                  idx % 2 === 0 ? "bg-orange-100 border-orange-300" : "bg-green-100 border-green-300"
                }`}
              >
                <h1
