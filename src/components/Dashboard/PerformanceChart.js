  ...
  const renderCharts = () => {
    if (
      ...
      if (quizProgress.length === 1) {
        return (
          <div className="bg-white p-2.5 rounded-lg flex flex-col items-center xl:h-auto h-full" style={{ boxShadow: "0px 5px 25px 0px rgba(62, 144, 156, 0.10)" }}>
            <div className="semicircle-map w-full">
              <div className="flex flex-col">
                <span className="text-xl font-semibold" style={{ color: "#595F6E" }}>
                  My Progress
                </span>
                <span className="text-sm font-light mb-5" style={{ color: "#595F6E" }}>
                  {quizProgress[0].name}
                </span>
              </div>
              <Chart
        ...
        return (
          ...
          <div className="Outfit text-xl font-semibold text-slate-600">My Progress</div>
          <Slider {...progressBar}>
